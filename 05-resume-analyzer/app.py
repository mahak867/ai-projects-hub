"""
AI Resume Analyzer
Upload your resume + paste a job description → get a detailed match analysis.
"""
...
def extract_pdf(file: io.BytesIO) -> str:
    """Extract plain text from a PDF file.

    Args:
        file: PDF as a file-like object
...
def analyze_resume(
    ...
    Returns:
        Dictionary with match_score, missing_skills, improvements, and more
...
if st.button("🔍 Analyze Match", type="primary", use_container_width=True):
    ...
    with st.spinner("Analyzing your resume... (~15 seconds)"):
        ...
        try:
            result = analyze_resume(api_client, resume_text, jd_text)
